...
import { useAccommodation } from '../redux'
import InputComponent from '@/core/components/input-component'
import Accommodation from '../redux/constanst';

function SearchAccommodationComponent() {
    const { city, setCity } = useAccommodation(s => s as Accommodation);
...
export default SearchAccommodationComponent