    ...
    return (
        <div className="w-full flex items-center justify-between">
            <div className="flex gap-4">
                <InputComponent
                    Icon={
                        <svg className="pointer-events-none absolute top-1/2 transform -translate-y-1/2 left-4" width="14" height="15" viewBox="0 0 22 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    styleInput={"text-large font-[600] uppercase bg-[#EBEBFF] shadow-default text-[#B0B0D9] rounded-l-lg py-[1.25rem] pl-12 w-full"}
                />
                <InputComponent
                    Icon={
                        <svg className="pointer-events-none absolute top-1/2 transform -translate-y-1/2 left-4" width="14" height="15" viewBox="0 0 22 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    disabled={to}
                    styleContainer={"relative text-gray-400 focus-within:text-gray-600 flex items-center w-[150px]"}
                    styleInput={"text-large font-[600] uppercase bg-[#EBEBFF] shadow-default text-[#B0B0D9] rounded-r-lg py-[1.25rem] pl-12 w-full"}
                />
            </div>
            <div className="flex gap-4">
                <InputComponent
                    placeholder={"Ida"}
                    disabled={from}
                    styleInput={"text-large font-[600] uppercase bg-[#EBEBFF] shadow-default text-[#B0B0D9] rounded-l-lg py-[1.25rem] pl-8 w-[150px]"}
                />
                <InputComponent
                    placeholder={"Vuelta"}
                    disabled={to}
                    styleInput={"text-large font-[600] uppercase bg-[#EBEBFF] shadow-default text-[#B0B0D9] rounded-r-lg py-[1.25rem] pl-8 w-[150px]"}
                />
            </div>
            <CountDropdownPeopleComponent />
            <button className="text-large font-[600] uppercase rounded-lg bg-primary p-4 rounded-lg text-white font-semibold">
